<template>
    <div class="sidebar">
        <a v-bind:class="{active : isActive.details}" href="#details" v-on:click = "swap" id = "details">Your Details</a>
        <a v-bind:class="{active : isActive.orders}" href="#orders" v-on:click = "swap" id = "orders">Orders</a>
        <a v-bind:class="{active : isActive.dashboard}" href="#dashboard" id = "dashboard">Statistics</a>
    </div>
</template>
